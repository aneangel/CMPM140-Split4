...
public class CameraFollow : MonoBehaviour
{
    ...
    [SerializeField] private float xOffset; //To add offset from player
    ...
    void FixedUpdate()
    {
        ...
        Vector3 newPosition = new Vector3(target.position.x + xOffset, target.position.y, -10f); //-10f because that is the default position of Cameras
